...
export default function Services() {
  ...
  const ENHANCED_PLUS_URL = "https://cal.com/dr.-nicole-cox-jordan/enhanced-body-sculpting-fat-freezing-plus-toning-strengthening-and-nutrition";
  const CRYO_URL = "https://cal.com/dr.-nicole-cox-jordan/elevated-targeted-cryotherapy?overlayCalendar=true";
  const ELITE_URL = "https://cal.com/dr.-nicole-cox-jordan/elite-vip-concierge-experience";
  const EXISTING_PATIENT_URL = "https://cal.com/dr.-nicole-cox-jordan/existing-patient-consultation-premium-service-s";
        ...
        <section className="py-20 md:py-28 bg-primary text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto px-4 space-y-8">
            ...
            >
              ...
              <a href={EXISTING_PATIENT_URL} target="_blank" rel="noopener noreferrer">
                <Button
                  size="lg"
                  variant="outline"
