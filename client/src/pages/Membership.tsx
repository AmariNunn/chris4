...
const tiers = [
  {
    ...
    details: [],
    bookingUrl: "https://cal.com/dr.-nicole-cox-jordan/essential-jordan-wellness-experience",
    accent: false,
  },
  {
    icon: Sparkles,
    ...
    bookingUrl: "https://cal.com/dr.-nicole-cox-jordan/enhanced-jordan-wellness-experience-body-sculpting-fat-freezing",
    accent: true,
  },
  {
    icon: Snowflake,
    ...
    bookingUrl: "https://cal.com/dr.-nicole-cox-jordan/elevated-targeted-cryotherapy?overlayCalendar=true",
    accent: false,
  },
  {
    icon: Crown,
    ...
    bookingUrl: "https://cal.com/dr.-nicole-cox-jordan/elite-vip-concierge-experience",
    accent: true,
  },
];
                  ...
                  <div className="p-8 md:p-10">
                    <div className="flex flex-col md:flex-row md:items-start gap-6">
                      ...
                      <div className="flex-1 space-y-4">
                        ...
                        {(tier as any).bookingUrl && (
                          <div className="pt-2">
                            <a href={(tier as any).bookingUrl} target="_blank" rel="noopener noreferrer">
                              <Button
                                size="lg"
                                className={`rounded-full px-8 ${tier.accent ? "bg-accent text-white hover:bg-accent/90" : "bg-accent text-white hover:bg-accent/90"} shadow-md`}
                                data-testid={`button-book-tier-${i}`}
                              >
                                Begin Your Journey
                              </Button>
                            </a>
