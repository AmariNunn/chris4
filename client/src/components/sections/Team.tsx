...
const team = [
  {
    ...
    bio: [
      ...
      "She earned her Doctor of Chiropractic (DC) degree from Parker College of Chiropractic in Dallas, Texas, after completing her undergraduate studies at Fisk University. Dr. Nicole is a proud Silver Star member of Alpha Kappa Alpha Sorority, Inc. Her commitment to lifelong wellness is reflected in her personalized approach to patient care.",
    ],
  },
  {
                ...
                <div className="relative">
                  <div className="relative overflow-hidden rounded-md">
                    <img
                      ...
                      className="w-full h-[480px] object-contain bg-muted/5"
